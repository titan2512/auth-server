...
import tech.lmru.auth.grpc.service.generated.impl.SimpleMess;
...
public class TokenServiceImpl extends TokenServiceImplBase {
    ...
    @Override
    public void checkToken(SimpleMess request, StreamObserver<AccessToken> responseObserver) {
        Map<String, ?> map = null;
        try{
            map = checkTokenEndpoint.checkToken(request.getInfo());
